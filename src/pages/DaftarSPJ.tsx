...
import { Search, Filter, Eye, Trash2, CheckCircle, RotateCcw, Archive, FileText, FileDown, Pencil, Copy } from "lucide-react";
                      ...
                      <tr key={item.id} className="border-b last:border-0 hover:bg-muted/30 transition-colors">
                        ...
                        <td className="py-3 px-4">
                          <div className="flex items-center justify-center gap-1">
                            ...
                            <Button variant="ghost" size="sm" title="Duplikasi" onClick={() => duplicateKegiatan(item)}>
